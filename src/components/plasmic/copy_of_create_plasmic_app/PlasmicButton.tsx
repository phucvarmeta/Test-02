...
import sty from "./PlasmicButton.module.css"; // plasmic-import: pebvEhCM1kxQ/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: QH2W2JX37E1Y/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Q0IDqBnBb8v7/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__vxUtq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__rXu2R)}
                role={"img"}
              />
            ),
