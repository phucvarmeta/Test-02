...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: SBs5lWXRLDAX/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__litIa)}>
        <div className={classNames(projectcss.all, sty.freeBox___6KuBx)} />

        <div className={classNames(projectcss.all, sty.freeBox___49BS)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___5FKiV)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__vJsPb)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__k3D5X)}
            >
              <LinkButton
