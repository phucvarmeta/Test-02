...
import sty from "./PlasmicButton.module.css"; // plasmic-import: t5NAnZza_oxe/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: c7YN5AyxeEUP/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ySz5K)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__nlQcX)}
                role={"img"}
              />
            ),
